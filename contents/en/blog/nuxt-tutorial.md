---
name: 'nuxt-tutorial'
title: SPA using the NuxtJS Framework
year: 21 December 2019
color: '#8e7964'
trans: 'nuxt-tutorial'
id: 'nuxt-tutorial'
description: |
  How I started my journey with nuxtJS and VueJs. This article will be give brief discussion about vue and NuxtJS
---

## Why I moved from Vue to NuxtJS?

Although some of you already know me, I am [Praveen Yen](https://twitter.com/praveenyen), Back-end Developer at [MiStay](https://mistay.in).
...
My previous website was made with the **MEVN** tech stack. After that I was moved to use the **NuxtJS** as my default
